...
TEST_F(RoutePlannerTest, TestAddNeighbors) {
	...
	// this works fine on virtual machine
	// but on Windows with VC
	// the last two nodes are inverted, there is no way to change it, so must be inverted at this test
	...
	std::vector<float> start_neighbor_g_vals{ 0.10671431, 0.082997195, 0.055291083, 0.051776856 };
	std::vector<float> start_neighbor_h_vals{ 1.1828455, 1.0998145, 1.1831238,1.0858033 };
